...
# ============================================================================
# ENDPOINT D'INITIALISATION DE LA BASE DE DONNÉES (PRODUCTION)
# ============================================================================
...
async def init_database(request: InitDatabaseRequest):
    ...
    try:
        ...
        if existing_users > 0:
            return {
                "status": "already_initialized",
                "message": f"La base de données contient déjà {existing_users} utilisateur(s)",
                "users_count": existing_users
            }
        
        # Créer le compte Directeur principal
        directeur = {
            "id": str(uuid.uuid4()),
            "email": "directeur@cabinet.fr",
        ...
        # Créer le compte Super Admin (protégé)
        super_admin = {
            "id": str(uuid.uuid4()),
            "email": "admin@cabinet.fr",
            "password_hash": pwd_context.hash("SuperAdmin2025!"),
            "prenom": "Administrateur",
            "nom": "Système",
            "role": "Directeur",
            "actif": True,
        ...
        await db.users.insert_many([directeur, super_admin])
